...
from apps.common.helpers import storage_file_path
from apps.common.managers import BaseActiveObjectMangerQueryset, BaseObjectManagerQuerySet
from apps.common.model_fields import AppSingleFileField
...
class BaseActiveModel(BaseModel):
    """
    Contains the last modified and the created fields, basically
    the base model for the entire app additionally is_active field is added
    cause every model dose not required active field
    ...
    ********************* Model Fields *********************
    ...
    objects = BaseActiveObjectMangerQueryset.as_manager()
...
class BaseFileUploadModel(BaseModel):
    """Base Abstract Model for File Upload.
    ...
    ********************* Model Fields *********************
    ...
    file = AppSingleFileField(upload_to=storage_file_path, null=True, blank=True)
